    ...
    haobook-typst:
      ...
      ensurePdfRegexMatches:
        - # Chapter 1 figure captions and references
          ...
          - "Waveluma"
          - "Appendorba"
          # Note: Constantia is in margin table, not reliably extracted by pdftotext
          - "Databvisual"
          - "Unitaria"
          - "Ankylosaura"
          - "Diplodoca"
      ...
      ensurePdfTextPositions:
        - # Code listings should be left-aligned with body text, not centered.
          ...
          - subject: "Coperniciana"
            relation: leftOf
            object: "Galileana"
            page: 6  # verso page - margin on left; both on page 6
          - subject: "Telescopia"
            relation: leftOf
            object: "Galileana"
          ...
          - subject: "Elementica"
            relation: leftOf
            object: "Chromatus"
            page: 12  # verso page - margin on left; both on page 12
          - subject: "Waveluma"
            relation: leftOf
            object: "Chromatus"
          ...
          - subject: "Prolegomena"
            relation: rightOf
            object: "Philologica"
            page: 13  # recto page - margin on right; both on page 13
          - subject: "Scholiasta"
            relation: rightOf
            object: "Philologica"
